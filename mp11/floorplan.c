...
node_t* init_slicing_tree(node_t* par, int n) {
    ...
    newRightNode->parent = newLeftNode;
    newRightNode->cutline = UNDEFINED_CUTLINE;
    newRightNode->module = &modules[n];
    newRightNode->left = NULL;
    newRightNode->right = NULL;

    newLeftNode->parent = par;
    newLeftNode->cutline = V;
    newLeftNode->module = NULL;
    newLeftNode->left = init_slicing_tree(newLeftNode, n + 1);
    newLeftNode->right = newRightNode;
